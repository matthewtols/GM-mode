...
if (JSON.parse(localStorage.getItem("saves")) == null) {
	var savedLeagues = []
	var savedLeagueTeams = []
	var savedLeagueRosters = []
	var savedLeaguePlayers = []
} else {
	var savedLeaguesCounter;
	var savedLeagues = JSON.parse(localStorage.getItem("saves"))
	var savedLeagueTeams = JSON.parse(localStorage.getItem("teamers"))
	var savedLeagueRosters = JSON.parse(localStorage.getItem("rosters"))
	var savedLeaguePlayers = JSON.parse(localStorage.getItem("players"))
...
function teamPickToggler() {
	...
	for (playerGenCounterForward = 0; playerGenCounterForward < 500; playerGenCounterForward++) {
		...
		var passingOverall = passAccuracy * ((passing / 100) + addition2)
	...
	for (a = 0; a < 31; a++) {
		...
		for (c = 0; c < 2; c++) {
			NHLplayer[a * 6 + 1 + b][23] = "tid" + a
			NHLplayer[a * 6 + 3 + b][23] = "tid" + a
			NHLplayer[a * 6 + 5 + b][23] = "tid" + a
		}
	}
	...
	for(food = 0; food < 500; food++) {
		...
		for(uniqueCounter = 0; uniqueCounter < 20; uniqueCounter++) {
			if (playerTeamName < 31 && playerTeamName >= 0) {
				...
				var playerTeamName = NHLteamAbrev[NHLplayer[food][23].slice(3, NHLplayer[food][23].length)]
				document.getElementById("team32roster").innerHTML += '<tr id="playerRow' + food + '"><td class="tdata">' + playerTeamName + '</td><td class="tdata2">' + NHLplayer[food][1] + '</td><td class="tdata">' + NHLplayer[food][0] + '</td><td class="tdata">' + NHLplayer[food][2] + '</td><td class="tdata">' + NHLplayer[food][3] + '</td><td class="tdata">' + NHLplayer[food][5] + '</td><td class="tdata">' + NHLplayer[food][6] + '</td><td class="tdata">' + NHLplayer[food][8] + '</td><td class="tdata">' + NHLplayer[food][7] + '</td><td class="tdata">' + NHLplayer[food][10] + '</td><td class="tdata">' + NHLplayer[food][9] + '</td><td class="tdata">' + NHLplayer[food][24] + '</td><td class="tdata">' + NHLplayer[food][11] + '</td><td class="tdata">' + NHLplayer[food][13] + '</td><td class="tdata">' + NHLplayer[food][12] + '</td><td class="tdata">' + NHLplayer[food][25] + '</td><td class="tdata">' + NHLplayer[food][15] + '</td><td class="tdata">' + NHLplayer[food][14] + '</td><td class="tdata">' + NHLplayer[food][16] + '</td><td class="tdata">' + NHLplayer[food][17] + '</td><td class="tdata">' + NHLplayer[food][18] + '</td><td class="tdata">' + NHLplayer[food][26] + '</td><td class="tdata">' + NHLplayer[food][20] + '</td><td class="tdata">' + NHLplayer[food][19] + '</td></tr>'
				break;
			}
		}
	}
...
document.getElementById("showLineups").addEventListener("click", showLineups)
